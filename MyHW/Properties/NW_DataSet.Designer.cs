...
namespace MyHW.Properties.NW_DataSetTableAdapters {
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        public virtual NW_DataSet.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual NW_DataSet.ProductsDataTable GetDataBy1(string productname) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((productname == null)) {
                throw new global::System.ArgumentNullException("productname");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual NW_DataSet.ProductsDataTable GetDataBy(global::System.Nullable<decimal> unitprice1, global::System.Nullable<decimal> unitprice2) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((unitprice1.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(unitprice1.Value));
            }
